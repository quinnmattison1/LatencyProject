...
public class WorkLoad extends WorkLoadDescription implements ReliabilityParameters {
	...
	/**
	*Class WorkLoad handles all the work for the communication to the nodes. Including keeping track of
	*faults and connection security.
	* @param numFaults keeps a running tally of faults
	* @param minPacketReceptionRate holds the minimum packet reception rate
	* @param e2e target value for element to element transmission
	* @param intForNodeNames Boolean var, true if there is int, false if not and default
	* @param intForFlowNames Boolean var, true if there is int, false if not and default
	* @param flows map of all flow nodes in the WARP graph (<name, Flow>)
	* @param nodes map of all graph nodes in the WARP graph (<name, Node>)
	* @param name name of the WARP graph defining the workload
	* @param flowNamesInOriginalOrder array to hold names of flows to preserve their order
	* @param flowNamesInPriorityOrder array to hold names of flows in priority order
	*
	*/
  ...
  */
  ...
  /**
   * Returns the list of all flows in priority orders as an ArrayList object.
  ...
  /**
   * The intForNodeNames to set.
   * @param intForNodeNames 
   */
  ...
  /**
   * The intForFlowNames to set.
   * @param intForFlowNames 
   */
  ...
  /** The flowNamesInOriginalOrder to set.
   * @param flowNamesInOriginalOrder 
   */
  ...
  /**
   * The flowNamesInPriorityOrder to set.
   * @param flowNamesInPriorityOrder 
   */
  ...
  */
  ...
  /**
   *Calculates the HyperPeriod which is the LCM of all flows.
   * 
   * @return hyperPeriod
   */
   ...
   * 
   * @param flowName
   * @return Array of integers that represents the transmission attempts
   */
