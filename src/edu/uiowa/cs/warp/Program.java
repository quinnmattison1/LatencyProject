...
public class Program implements SystemAttributes {
  ...
  */
  ...
  /**
   * Returns the program schedule of the flows.
  ...
  @Override
  /*
   * Returns the scheduler name of the flows.
   * @return schedulerBuilt
   */
  ...
  /**
   * Maps the names of the nodes to the respective indicies.
   * @return A HashMap -> Keys = NODE NAMES // Values = Indicies in Schedule Table
   */
